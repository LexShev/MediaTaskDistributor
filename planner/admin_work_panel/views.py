...
def admin_index(request):
    ...
    if worker_id:
        try:
            init_dict = AdminModel.objects.get(owner=worker_id)
        ...
        init_dict = AdminModel.objects.get(owner=0)
    ...
    if request.method == 'POST':
        ...
        form = AdminForm(request.POST, instance=init_dict)
        if form.is_valid():
        ...
        form = AdminForm(instance=init_dict)
    ...
    return render(request, 'admin_work_panel/admin_work_panel.html', data)
