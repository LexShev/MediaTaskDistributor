...
([permission_group], [day], [month], [week], [list], [kpi_info], [work_calendar], [common_pool], [full_info_card])
VALUES 
('admin', 1, 1, 1, 1, 1, 1, 1, 1),
('preparation_engineer', 1, 1, 1, 1, 1, 1, 1, 1),
('broadcast_engineer', 0, 1, 0, 0, 1, 1, 1, 1),
('otk', 0, 1, 0, 0, 1, 1, 1, 1),
('editor', 0, 1, 0, 0, 1, 1, 1, 1);